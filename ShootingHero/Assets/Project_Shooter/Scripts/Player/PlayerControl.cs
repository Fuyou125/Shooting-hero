...
namespace Shooter.Gameplay
{
    public class PlayerControl : MonoBehaviour
    {
        // 玩家角色和飞机对象
        [HideInInspector]
        public PlayerChar MyPlayerChar;  // 玩家角色
        ...
        [Space]
        public Transform m_AimPointTransofrm;  // 用于表示瞄准点的Transform
        ...
        void Update()
        {
            ...
            if (!m_IsDead)
            {
                if (PlayerChar.m_Current.m_IsDead)
                {
                    ...
                    GameControl.m_Current.HandlePlayerDeath();  // 处理玩家死亡逻辑
                }
            }
        }
        ...
        public void UpdateInputs()
        {
            ...
            m_AimPointTransofrm.position = AimPosition;  // 更新瞄准点的位置
        }
        ...
        public void Respawn()
        {
            ...
            MyPlayerChar = obj.GetComponent<PlayerChar>();  // 获取玩家角色组件
            ...
            {
                int num = GameControl.m_Current.m_MainSaveData.m_CheckpointNumber - 1;  // 根据存档检查点的编号来设置重生位置
                MyPlayerChar.transform.position = CheckpointControl.m_Main.m_Checkpoints[num].m_SpawnPoint.position;  // 设置玩家位置
            }
        }
    }
}
