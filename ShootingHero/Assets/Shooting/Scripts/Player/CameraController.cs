...
namespace Shooting.Gameplay
{
    ...
    public class CameraController : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            Vector3 targetPosition = PlayerCharacter.m_Current.transform.position; // 目标位置，默认是玩家的位置
        ...
        void Update()
        {
            ...
            // 更新最小Z轴位置（玩家的Z轴位置+8）
            if (PlayerController.MainPlayerController.MyPlayerChar.transform.position.z + 8 > m_MinZ)
            {
                m_MinZ = PlayerController.MainPlayerController.MyPlayerChar.transform.position.z + 8;
            }
