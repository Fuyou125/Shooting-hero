...
namespace Shooting
{
    ...
    {
        [HideInInspector] public PlayerCharacter MyPlayerChar; // 玩家角色
        ...
        [HideInInspector] public Vector3 m_Input_Movement; // 玩家移动输入
        [HideInInspector] public Vector3 AimPosition; // 玩家瞄准位置
        [HideInInspector] public bool Input_FireHold = false; // 持续开火输入

        [Space] public Transform m_AimPointTransform; // 用于表示瞄准点的Transform
        ...
        public void Respawn()
        {
            ...
            else
            {
                ...
                MyPlayerChar.transform.position =
                    CheckpointController.m_Main.m_Checkpoints[num].m_SpawnPoint.position; // 设置玩家位置
            }
        }
    }
}